        ...
        {user ? (
          <>
            <div className="profile">
              {user.picture && (
                <img src={user.picture} alt="" className="avatar-lg" referrerPolicy="no-referrer" />
              )}
              <div>
              ...
              <>
                ...
                <div className="dist">
                  ...
                  {Object.keys(dist).length === 0 && (
                    <p className="muted-text">No wins yet — go play!</p>
                  )}
                </div>
          ...
          <p className="muted-text signin-hint">
            Sign in from the <strong>Home</strong> tab to track your stats and streaks.
          </p>
        )}
